...
if Puppet.features.telnet?
  describe Puppet::Util::NetworkDevice::Cisco::Device do
    let(:transport) { stub_everything 'transport', is_a?: true, command: '' }
    let(:cisco) { Puppet::Util::NetworkDevice::Cisco::Device.new('telnet://user:password@localhost:23/') }
        ...
        expect(cisco.parse_vlans).to eq(
          ...
          '1' => {
            ...
            interfaces: [
              ...
              'FastEthernet0/6', 'FastEthernet0/7', 'FastEthernet0/8',
              'FastEthernet0/9', 'FastEthernet0/10', 'FastEthernet0/11',
              'FastEthernet0/12', 'FastEthernet0/13', 'FastEthernet0/14',
              'FastEthernet0/15', 'FastEthernet0/16', 'FastEthernet0/17',
